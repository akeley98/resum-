...
\definecolor{webColor}{RGB}{0, 72, 180}
\newcommand{\web}[1]{{ \color{webColor} \small \url{#1}}}
\newcommand{\webText}[2]{{\color{webColor} \href{#1}{#2}}}
\definecolor{titleColor}{RGB}{140, 70, 150}
...
Advanced Computer Architecture, Machine Learning, Algorithms \&
Complexity, Formal Languages \& Automata

\myKey{Select Mathematics Courses} Linear Algebra, Complex Analysis
Honors, Algebra Honors, Galois Theory, Mathematical Modeling
\vspace{3mm}
...
small triangles generated. Myricube uses conventional\footnote{Well,
  actually I eventually switched to instanced rendering with
  \texttt{glDrawElementsInstancedBaseVertexBaseInstance}, but this
  paragraph is long enough already.} mesh rendering for nearby voxels
