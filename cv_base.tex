...
\resumeMiniItemURL{https://github.com/akeley98/MediocrePy}{%
...
\resumeMiniItem{Microlensing event light curve fitting with Python, \lighttt{C++}, SciPy, and Matplotlib}
\ifdefined\CV
\begin{enumerate}
...
\resumeMiniItem{Product testing and English documentation/marketing for RemixOS}
\ifdefined\CV
\begin{enumerate}
...
\resumeMiniItemURL{https://youtu.be/YwvMSeB6NzU}{%
...
\resumeMiniItemURL{https://github.com/akeley98/myricube}{%
...
\ifdefined\RESUME
\mySub{Proposed gem5 Partial Bypassing Patch}
\resumeMiniItemURL{https://gem5-review.googlesource.com/c/public/gem5/+/27767}{%
